...
import net.friendsmap.ayrsa.friendsmap.Models.FriendRequestStatus;
...
public class FriendsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        NetworkManager.builder()
                .setUrl(FriendsMap.BaseUrl + "/api/user/GetUserMessagesCount")
    ...
    private void GetUserFriends(MenuActivity menuActivity, AVLoadingIndicatorView loadingIndicatorView) {
        ...
        NetworkManager.builder()
                .setUrl(FriendsMap.BaseUrl + "/api/user/GetUserFriends")
