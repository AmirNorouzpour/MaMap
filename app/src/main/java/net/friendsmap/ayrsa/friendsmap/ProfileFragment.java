...
import net.friendsmap.ayrsa.friendsmap.Models.MenuAdapter;
...
import net.friendsmap.ayrsa.friendsmap.Utils.GifSizeFilter;
import net.friendsmap.ayrsa.friendsmap.Utils.Glide4Engine;
...
//    }
    ...
    private void GetUserMenus() {
        ...
        NetworkManager.builder()
                .setUrl(FriendsMap.BaseUrl + "/api/user/GetUserMenu")
    ...
    private void SendImageToServer(File file) {
        NetworkManager.builder()
                .setUrl(FriendsMap.BaseUrl + "/api/user/UploadPicture")
