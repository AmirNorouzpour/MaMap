...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        UpgradeAccountLayout.setOnClickListener(v -> OpenActivity(-1, UpgradeActivity.class));// GeneralUtils.showToast("نسخه آزمایشی محدودیتی ندارد", Toast.LENGTH_SHORT, OutType.Success)
